...
globalkeys = awful.util.table.join(
    ...
    -- special keys
    awful.key({ modkey }, "XF86Back", function () awful.screen.focus(1) end),
    awful.key({ modkey }, "XF86Forward", function () awful.screen.focus(0) end),
    awful.key({ modkey, "Control" }, "Left", function () awful.screen.focus(1) end),
    awful.key({ modkey, "Control" }, "Right", function () awful.screen.focus(0) end),
    awful.key({ }, "XF86Forward", awful.tag.viewnext ),
    awful.key({ }, "XF86Back", awful.tag.viewprev ),
    awful.key({ "Control" }, "XF86Forward", awful.client.movetoscreen ),
    awful.key({ "Control" }, "XF86Back", awful.client.movetoscreen ),
