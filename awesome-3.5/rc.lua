...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey }, "c", function () awful.util.spawn_with_shell("luakit") end ),
    ...
    awful.key({ modkey, "Control" }, "Left", function () awful.util.spawn("xbacklight -dec 10") end),
    awful.key({ modkey, "Control" }, "Right", function () awful.util.spawn("xbacklight -inc 10") end)
)
...
dbus.connect_signal("ru.gentoo.kbdd", function(...)
    ...
    local layout = data[2]
    lts = {[0] = "Eng", [1] = "Рус"}
    widgets.kbdwidget:set_markup(" "..lts[layout].." ")
    end
)
